...
public class SecurityValidator {
    ...
    /**
     * Valida la existencia de una tabla para prevenir accesos no autorizados o
     * errores de consulta.
     */
    public void validateTableExistence(String database, String schema, String table, String sessionId)
            throws SQLException {
        if (!metadataService.tableExists(database, schema, table, sessionId)) {
    ...
    /**
     * Genera un nombre de tabla seguro (escapado) adaptado al motor de base de
     * datos.
     */
    public String getSafeTableName(String database, String schema, String table, String sessionId) {
        try (Connection conn = jdbcTemplate.getDataSource().getConnection()) {
            ...
            String effectiveSchema = metadataService.resolveSchema(schema, conn, sessionId);
